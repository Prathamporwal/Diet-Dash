...
DATABASES = {
    'default': {
        ...
        'NAME': 'dietdsah',         # Make sure this DB exists
        'USER': 'root',             # Default user if you're using root
        'PASSWORD': 'password', # Replace with your MySQL root password
        'HOST': '127.0.0.1',        # 👈 localhost or 127.0.0.1 for local setup
        'PORT': '3306',
    }
}
